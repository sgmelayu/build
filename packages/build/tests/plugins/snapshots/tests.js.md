...
## Can execute local binaries when using plugins cached in the build image
...
> Snapshot 1
    ...
    Packaging Functions from functions directory:␊
     - test/test.js␊
    ␊
    (@netlify/plugin-functions-core onBuild completed in 1ms)␊
    ␊
    ┌─────────────────────────────┐␊
    │   Netlify Build Complete    │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    ␊
    ┌─────────────────────────────────────────────────────────┐␊
    │ 1. onPostBuild command from @netlify/plugin-deploy-core │␊
    └─────────────────────────────────────────────────────────┘␊
    ␊
    ␊
    ┌─────────────────────────────────────────────────────┐␊
    │ Plugin "@netlify/plugin-deploy-core" internal error │␊
    └─────────────────────────────────────────────────────┘␊
    ␊
      Error message␊
    ...
    ␊
      Plugin details␊
      Package:        @netlify/plugin-deploy-core␊
      Version:        1.0.0␊
    ...
    ␊
      Error location␊
      In "onPostBuild" event in "@netlify/plugin-deploy-core" from core␊
    STACK TRACE␊
    ␊
      Resolved config␊
      {}`
...
> Snapshot 1
    ...
    ␊
    ┌─────────────────────────────────────────────┐␊
    │ Plugin "@netlify/plugin-deploy-core" failed │␊
    └─────────────────────────────────────────────┘␊
    ␊
      Error message␊
      Error: Deploy did not succeed: test␊
...
> Snapshot 1
    ...
    ␊
    (@netlify/plugin-deploy-core onPostBuild completed in 1ms)␊
    ␊
    ┌─────────────────────────────┐␊
    │   Netlify Build Complete    │␊
    └─────────────────────────────┘␊
...
> Snapshot 1
    ...
    ␊
    ┌────────────────────────────────────────────────┐␊
    │ Plugin "@netlify/plugin-functions-core" failed │␊
    └────────────────────────────────────────────────┘␊
    ␊
      Error message␊
